...
const RESOURCES := [
	...
	"res://Scenes/Plants/Biomes/MeadowPlants.tscn",
	"res://Scenes/Plants/Biomes/GrassShader.tres",
	"res://Scenes/Plants/Biomes/Stylized3DGrass.tres",
	"res://Entities/Buildings/Building.gd",
	"res://Entities/Buildings/Factory.gd",
	...
	"res://Scenes/WorkScenes/Farm/FarmWorkFieldData.gd",
	"res://Scenes/WorkScenes/Farm/FarmWorkInteractable.gd",
	"res://Scenes/WorkScenes/Farm/FarmWorkInventory.gd",
	"res://Scenes/WorkScenes/Farm/FarmWorkProductionState.gd",
	...
	"res://tools/codex_factory_delivery_test.gd",
