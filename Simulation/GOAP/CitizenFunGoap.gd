...
func _build_actions() -> Array:
	...
	actions.append(GoapActionScript.new(
		"go_park",
		1.0,
		{"has_park": true, "at_park": false, "is_night": false, "energy_ok": true},
		{"at_park": true, "at_home": false, "at_shop": false, "at_cinema": false}
	))
	actions.append(GoapActionScript.new(
		"go_shop",
		0.95,
		{"has_shop": true, "at_shop": false, "is_night": false, "can_afford_shop": true, "energy_ok": true},
		{"at_shop": true, "at_home": false, "at_park": false, "at_cinema": false}
	))
	actions.append(GoapActionScript.new(
		"go_cinema",
		1.1,
		{"has_cinema": true, "at_cinema": false, "is_night": false, "can_afford_cinema": true},
	...
	actions.append(GoapActionScript.new(
		"buy_clothes",
		0.65,
		{"at_shop": true, "can_afford_shop": true},
		{"fun_recovered": true}
	))
	actions.append(GoapActionScript.new(
		"watch_cinema",
		0.7,
		{"at_cinema": true, "can_afford_cinema": true},
		{"fun_recovered": true}
	))
	actions.append(GoapActionScript.new(
		"relax_home",
