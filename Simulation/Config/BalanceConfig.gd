	...
	return {
		...
		"transport": {
			...
			"vehicle": {
				...
				"center_of_mass_y": 0.12,
				"center_of_mass_z": -0.45,
				"manual_drive_enabled": true,
				"manual_engine_force": 40.0,
				"manual_reverse_force_multiplier": 1.7,
				"manual_brake_strength": 2.2,
				"manual_parking_brake": 6.0,
				"manual_steer_speed": 1.5,
				"manual_steer_limit": 0.42,
				"manual_max_speed": 4.5,
				"manual_reverse_speed": 2.0,
				"manual_low_speed_force_boost": 2.5,
				"manual_forward_engine_sign": 1.0,
				"wheel_track_half_width": 0.26,
				"wheel_front_z": 0.04,
				"wheel_rear_z": -1.0,
				"wheel_mount_y": 0.16,
				"wheel_radius": 0.155,
				"wheel_roll_influence": 0.28,
				"wheel_friction_slip": 1.25,
				"suspension_stiffness": 20.0,
				"suspension_travel": 0.16,
				"damping_compression": 1.0,
				"damping_relaxation": 1.8,
				...
				"physics_collision_layer": 4,
				"physics_collision_mask": 5,
				"route_vehicle_avoidance_enabled": true,
				"route_vehicle_detection_distance": 4.5,
				...
				"route_curbside_pullout_enabled": true,
				"route_curbside_pullout_offset": 0.9,
				"route_curbside_pullout_length": 2.0,
				"obey_traffic_lights": true,
				"traffic_light_detection_distance": 6.0,
				"traffic_light_lateral_tolerance": 0.85,
				"traffic_light_stop_distance": 0.95,
				"traffic_light_slowdown_distance": 3.0,
				"audio_enabled": true,
				"engine_audio_path": "res://environment/audio/vehicles/engine.wav",
				"impact_audio_path": "res://environment/audio/vehicles/impact_1.wav",
				"engine_audio_min_pitch": 0.05,
				"engine_audio_pitch_per_speed": 0.08,
				"engine_audio_idle_volume_db": -28.0,
				"engine_audio_drive_volume_db": -11.0,
				"engine_audio_lerp_speed": 8.0,
				"impact_speed_delta_threshold": 1.8,
				"impact_min_interval": 0.35,
				"impact_contact_linger_sec": 0.18,
				"impact_side_normal_max_y": 0.45,
			},
		},
		"economy": {
			...
			"jobs": {
				...
				"allowed_building_types": {
					...
					"Banker": ["BANK"],
					"MaintenanceWorker": ["CAFE", "CINEMA", "FACTORY", "FARM", "GAS_STATION", "RESIDENTIAL", "RESTAURANT", "SHOP", "SUPERMARKET", "CITY_HALL", "UNIVERSITY", "PARK", "HOSPITAL", "BANK", "TAXI_DEPOT", "LOGISTICS_DEPOT"],
					"Technician": ["FACTORY", "CITY_HALL", "HOSPITAL", "LOGISTICS_DEPOT"],
				},
			},
			"city_hall": {
		...
		"actions": {
			...
			"hospital_treatment": {
				...
				"max_minutes": 70,
				"target_health": 75.0,
				"emergency_min_minutes": 15,
				"emergency_max_minutes": 55,
				"emergency_target_health": 85.0,
				"health_add_per_min": 0.95,
				"emergency_health_add_per_min": 1.7,
			},
		},
		"planner": {
			...
			"health": {
				...
				"priority_scale": 20.0,
				"sick_work_skip_threshold": 55.0,
				"sick_work_skip_base_probability": 0.18,
				"sick_work_skip_max_probability": 0.75,
			},
			"emotion": {
				"enabled": true,
		...
		"buildings": {
			...
			"supermarket": {
				...
				"bread_start_stock": 12,
				"bread_restock_target": 36,
				"bread_restock_batch": 18,
			},
			"cinema": {
				"capacity": 35,
				"job_capacity": 5,
			...
			"hospital": {
				...
				"job_capacity": 5,
				"patient_capacity": 20,
				"treatment_capacity_per_hour": 6,
				"open_hour": 0,
				"close_hour": 24,
				"is_public_service": true,
				"service_quality": 1.0,
				"treatment_price": 25,
				"emergency_treatment_price": 60,
				"daily_operating_cost": 250,
				"patient_wait_timeout_minutes": 180,
				"charity_care_city_subsidy_ratio": 1.0,
				"citizen_payment_reserve": 35,
			},
			"university": {
				"capacity": 40,
				"job_capacity": 8,
			...
			"factory": {
				...
				"initial_clothes_stock": 48,
				"initial_entertainment_stock": 0,
				"direct_shop_delivery_enabled": true,
				"direct_delivery_batch_per_retailer": 24,
				"delivery_unload_duration_minutes": 8,
				"direct_delivery_price_multiplier": 0.85,
				"market_export_enabled": true,
				"market_export_limit_per_day": 0,
			},
			...
			"bank": {
				...
				"close_hour": 18,
				"start_balance": 12000,
				"base_operating_cost": 45,
				"min_operating_reserve": 3000,
				"borrower_cash_reserve": 220,
				"liquidity_target_days": 2.0,
				"max_loan_per_building": 800,
				"max_debt_per_building": 2400,
				"max_daily_lending": 3200,
				"repayment_rate": 0.25,
				"interest_rate_per_day": 0.03,
				"service_fee_per_loan": 6,
			},
			"church": {
				"capacity": 35,
				"job_capacity": 0,
