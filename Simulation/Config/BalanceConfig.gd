	...
	return {
		...
		"transport": {
			...
			"vehicle": {
				"max_speed": 5.0,
				"acceleration": 2.8,
				"braking_acceleration": 5.5,
				"braking_distance": 2.2,
				"turn_speed": 5.0,
				"waypoint_reach_distance": 0.45,
				"forward_yaw_offset": 0.0,
				"manual_drive_enabled": true,
				"manual_max_speed": 4.5,
				"manual_reverse_speed": 2.0,
				"manual_acceleration": 3.8,
				"manual_braking_acceleration": 6.5,
				"manual_coast_deceleration": 2.0,
				"manual_turn_speed": 1.7,
				"manual_min_turn_factor": 0.25,
				"ground_snap_enabled": true,
				"ground_probe_up": 2.0,
				"ground_probe_down": 8.0,
				"ground_height_offset": 0.0,
				"ground_snap_speed": 30.0,
				"ground_min_normal_y": 0.45,
		...
		"economy": {
			...
			"jobs": {
				...
				"wage_progression": {
					"education_max_level": 3,
					"education_bonus_per_level_weak": 0.03,
					"education_bonus_per_level_normal": 0.05,
					"education_bonus_per_level_strong": 0.08,
					"experience_daily_weak": -0.001,
					"experience_daily_normal": 0.00005,
					"experience_daily_strong": 0.0025,
					"experience_bonus_max": 0.10,
					"profit_smoothing_alpha": 0.25,
					"profit_weak_max": 0.0,
					"profit_strong_min": 250.0,
				},
				...
				"allowed_building_types": {
					...
					"MaintenanceWorker": ["CAFE", "CINEMA", "FACTORY", "FARM", "GAS_STATION", "RESIDENTIAL", "RESTAURANT", "SHOP", "SUPERMARKET", "CITY_HALL", "UNIVERSITY", "PARK"],
		...
		"planner": {
			...
			"personality": {
				"enabled": true,
				"work_motivation_weight": 1.0,
				"work_motivation_min": 0.5,
				"work_motivation_max": 1.5,
				"fun_interest_midpoint": 0.35,
				"fun_interest_scale": 0.6,
				"fun_personality_min": 0.7,
				"fun_personality_max": 1.3,
				"sociability_midpoint": 0.5,
				"sociability_scale": 0.6,
				"social_personality_min": 0.7,
				"social_personality_max": 1.3,
			},
			"goal_cooldowns": {
				"enabled": true,
				"hunger": 0,
		...
		"buildings": {
			...
			"cafe": {
				...
				"snack_price": 9,
				"snack_start_stock": 36,
				"snack_restock_target": 60,
				"snack_restock_batch": 22,
			},
			"shop": {
				"capacity": 25,
				"job_capacity": 4,
			...
			"farm": {
				...
				"open_hour": 5,
				"close_hour": 19,
				"base_food_output_per_day": 60,
				"production_cost_per_unit": 1,
				"crop_growth_days": 2,
				"harvest_duration_minutes": 45,
				"storage_capacity": 300,
				"direct_supermarket_delivery_enabled": true,
				"direct_delivery_batch_per_supermarket": 35,
				"delivery_unload_duration_minutes": 10,
				"direct_delivery_price_multiplier": 0.85,
				"market_export_enabled": true,
				"market_export_limit_per_day": 0,
			},
			"factory": {
				"capacity": 10,
				"job_capacity": 8,
			...
			"gas_station": {
				...
				"fuel_price": 7,
				"fuel_start_stock": 90,
				"fuel_restock_target": 140,
				"fuel_restock_batch": 50,
				"base_vehicle_sales_per_day": 18,
