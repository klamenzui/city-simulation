		...
		"economy": {
			...
			"jobs": {
				...
				"allowed_building_types": {
					...
					"Banker": ["BANK"],
					"MaintenanceWorker": ["CAFE", "CINEMA", "FACTORY", "FARM", "GAS_STATION", "RESIDENTIAL", "RESTAURANT", "SHOP", "SUPERMARKET", "CITY_HALL", "UNIVERSITY", "PARK", "HOSPITAL", "BANK"],
					"Technician": ["FACTORY", "CITY_HALL", "HOSPITAL"],
				},
			},
			"city_hall": {
